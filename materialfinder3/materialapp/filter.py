...
class MaterialFilter(django_filters.FilterSet):
    ...
    #Arrays für die AllValuesMultipleFilter
    ...
    # Filter für alle nicht-Boolean Fields. Für mehr Informationen zu den Filtern https://django-filter.readthedocs.io/en/stable/# lesen
